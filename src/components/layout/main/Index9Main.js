			...
			<section id="cta" className="py-100px md:py-120px lg:py-140px bg-white dark:bg-[#121212] relative overflow-hidden">
				<div className="container relative z-10 px-6 md:px-8">
					<div className="max-w-4xl mx-auto text-center">
						<div className="text-center bg-gradient-to-br from-black via-[#121212] to-[#4CAF50] rounded-30px p-12 md:p-16 border border-[#4CAF50]/30 relative overflow-hidden">
